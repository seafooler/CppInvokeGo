...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  void CallFunc(string funcname, i32 id,  paraList,  paraSet,  paraMap, MyClass mycla)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := project.NewDyninvThriftClientFactory(trans, protocolFactory)
	...
	case "CallFunc":
		if flag.NArg()-1 != 6 {
			fmt.Fprintln(os.Stderr, "CallFunc requires 6 args")
			flag.Usage()
		}
		...
		containerStruct2 := project.NewDyninvThriftCallFuncArgs()
		err15 := containerStruct2.ReadField3(jsProt14)
		if err15 != nil {
			Usage()
			return
		}
		argvalue2 := containerStruct2.ParaList
		value2 := argvalue2
		arg16 := flag.Arg(4)
		...
		containerStruct3 := project.NewDyninvThriftCallFuncArgs()
		err21 := containerStruct3.ReadField4(jsProt20)
		if err21 != nil {
			Usage()
			return
		}
		argvalue3 := containerStruct3.ParaSet
		value3 := argvalue3
		arg22 := flag.Arg(5)
		...
		containerStruct4 := project.NewDyninvThriftCallFuncArgs()
		err27 := containerStruct4.ReadField5(jsProt26)
		if err27 != nil {
			Usage()
			return
		}
		argvalue4 := containerStruct4.ParaMap
		value4 := argvalue4
		arg28 := flag.Arg(6)
		...
		argvalue5 := project.NewMyClass()
		err33 := argvalue5.Read(jsProt32)
		if err33 != nil {
			Usage()
			return
		}
		value5 := argvalue5
		fmt.Print(client.CallFunc(value0, value1, value2, value3, value4, value5))
		fmt.Print("\n")
		break
	case "":
		Usage()
